...
export function Footer({ lang, dict }: FooterProps) {
  ...
  const addressLines = dict.footer.address.split('\n')
  ...
  return (
    <footer className="bg-navy text-white">
          ...
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="mt-5 flex items-center gap-3">
                <a
                  href="https://facebook.com/cedeirabasketclub"
                  target="_blank"
            ...
            {/* Quick Links */}
            <div>
              <h3 className="font-display font-bold text-sm uppercase tracking-widest text-white mb-4">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-3 font-body text-sm text-gray-300">
                ...
                <li>
                  <a
                    href={`tel:+34${dict.footer.phone.replace(/\s/g, '')}`}
                    className="hover:text-white transition-colors"
                  >
                    {dict.footer.phone}
                  </a>
            ...
            <div>
              <h3 className="font-display font-bold text-sm uppercase tracking-widest text-white mb-4">
                {dict.nav.inscripcion}
              </h3>
              <p className="text-sm text-gray-300 leading-relaxed mb-4 font-body">
                {lang === 'gl'
                  ? 'Apúntate ao baloncesto de base en Cedeira. Categorías desde os 7 anos.'
                  : 'Apúntate al baloncesto de base en Cedeira. Categorías desde los 7 años.'}
              </p>
              <Link
      ...
      <Container className="py-5">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-300 font-body">
